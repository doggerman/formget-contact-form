...
* Go to "Contact Form Builder" tab and create your form by clicking on form fields.
 ...
 In order to add form to your website. Click the Embed link.
...
* Alternatively you can also use the WordPress Shortcode tab under the Form Builder tab and use the code over there in your WordPress pages/posts to make the form appear on selective pages only.
