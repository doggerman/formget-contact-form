...
FormGet Contact Form manage all your contact forms using single dashboard. Just drag and drop fields and your form is ready for use.

== Description ==
FormGet is a easy [online drag and drop contact form builder](http://www.formget.com) tool. This WordPress plugin is useful for different types of contact forms, Feedback Form, Helpdesk form,  booking forms, consultation services, Contact form, Mailing list form, Survey form, Job application form, Workshop registration form, Bug tracker form, Wedding planner form,Real estate applications form, Invitation/RSVP add invitation to the product demo forms, Online orders forms etc...

FormGet [Contact Form](http://www.formget.com) is an easy and effective form builder tool which enable you to build and embed form on your website in few steps. Select your fields, configure your options and easily embed contact form on your WordPress site by embedding tabbed or shortcode, no programming knowledge is required. With FormGet Contact Form manage all your contact forms and your entire client communication at one single place.
 
Full list of features:

* Online Form Builder.	
* Multiple form with in a Single Dashboard.	
* Unlimited Contact form entries.
* Upload File using contact form.
* Contact Form Validation using single click.	
* User can collect payments using PayPal in the contact form itself.	
...
* Agent receive notification on new ticket receive.
* You can assign agent for particular contact form or for single form category.
* Spam protection by advance captcha field.	
* complete data security using cloud servers.	
* Advance contact form analytic		
* Send email when you receive contact form entry.	
* Form Redirect after form Submission to your desire location. 	
...
* Just click on the field to add date and time field in contact form.	
* Advance Communication System for users interaction. 	
* Can create multiple agent for the contact forms.	
* Admin/ Agent can marked ticket as Resolved Ticket. 	
* Contact form Re-branding can be possible.
* Get the unique form URL and share it across the network.		
...
Click here to build [Advance Contact Form](http://www.formget.com).
...
2. After creating your form, Register yourself through a registration pop-up. Your form is now ready for embedding on your site.
...
Of course! FormGet Contact Form plugin works out-of-the-box with every WordPress theme. It work with the vast majority of premium and free themes, without requiring any coding.
...
In order to add form to your website visit the given link http://wordpress.org/plugins/formget-contact-form/screenshots/.
