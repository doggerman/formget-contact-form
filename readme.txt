...
Report bugs and paricipate in development at http://www.formget.com/contact-us/.
...
= Does the Contact Form Plugin save the request in database so that admin can view it? =

Because we host everything, when you designe a form with FormGet it automatically builds database. you can view all your entries from your dashboard of FormGet by making yourself logged in.
