...
1. Step 3. In order to add form to your website. Click the Embed link.
`/assets/screenshot-1.png`

2. Step 4. Click on Tabbed Widget and copy the whole code by clicking on "Copy Code" button.
`/assets/screenshot-2.png`

3. Step 5. Paste the copied code on "Emded Code" section in the plugin which appears on the "FormGet Contact Form" plugin dashboard inside WordPress Admin area.
